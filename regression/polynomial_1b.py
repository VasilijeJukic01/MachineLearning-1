# -*- coding: utf-8 -*-
"""Polinomijalna_Regresija_1b.ipynb
...
flag = False
colors = ['r', 'c', 'g', 'y', 'm', 'tab:orange', 'tab:pink']
lambda_list = [0, 0.001, 0.01, 0.1, 1, 10, 100]
loss_list = []

for i in range(7):
    d, w, b, h, xs, f, loss = polynomial(x, y, 4, alpha=0.001, epochs=50, normalize=True, regularization='l2', lambda_param=lambda_list[i])
    ...
    plot(d, w, b, h, xs, f, clr=colors[i], label=f'Lambda {lambda_list[i]}')

loss_values = [tensor.numpy() for tensor in loss_list]

sns.set(style="whitegrid")
plt.figure(figsize=(6, 4))
sns.lineplot(x=lambda_list, y=loss_values)
